    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->row(function ($row) {
                ...
                $row->column(3, new InfoBox('文章', 'book', 'yellow', '/admin/articles', '2786'));
                $row->column(3, new InfoBox('文件', 'file', 'blue', '/admin/files', '698726'));
            });
            ...
            //表格模块
            $headers = ['Id', '邮箱', '姓名', '公司名称', '最后登录时间', '现状'];
            $rows = [
            ...
            $content->row((new Box('Tables', new Table($headers, $rows)))->style('info')->solid());
        });
    }
