...
<body>
	...
	<img width="300" src="<?php echo e($code); ?>">
...
$(function(){
	...
	$("#requ").click(function(){
		var data = $('.data').val();
			$.post("<?php echo e(url('/wechat/key')); ?>",{url:data},function(msg){
					console.log(msg);
				});
			})
	...
	var on = 0;
	function code(){
	 	$.get("<?php echo e(url('wechat/status/'.$uuids)); ?>",function(data){
			arr = data.data.split(";");
	...
	$('#test').click(function(){
		key = "https://wx.qq.com/cgi-bin/mmwebwx-bin/webwxnewloginpage?ticket=Aa8wd03A2CbeNpnPKzuCgdWK@qrticket_0&uuid=4c9EWhtPGQ==&lang=zh_CN&scan=1480579158%22"
 		$.post("<?php echo e(url('/wechat/key')); ?>",{url:key},function(msg){
		 			console.log(msg);
		});
 	})
