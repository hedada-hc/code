			...
			<div class="pid-infro">
                ...
                <ul>
                    <li class="group-name clearfix">
                        ...
                        <input type="text" class="normal-input fl" id="name" name="name" placeholder="请输入分组名称" value="{{ $pid->name }}"/>
                    ...
                    <li class="clearfix">
                        ...
                        <input type="text" class="normal-input fl" id="common_pid" name="common_pid" placeholder="请输入通用PID" value="{{ $pid->common_pid }}"/>
                         <div class="error-box fl">
                    ...
                    <li class="clearfix">
                        ...
                        <input type="text" class="normal-input fl" id="queqiao_pid" name="queqiao_pid" placeholder="请输入鹊桥PID" value="{{ $pid->queqiao_pid }}"/>
                        <div class="error-box fl">
